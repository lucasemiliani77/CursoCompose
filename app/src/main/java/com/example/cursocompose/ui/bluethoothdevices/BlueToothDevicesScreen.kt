...
import com.example.cursocompose.ui.bluethoothdevices.dto.BluethoothDevices
...
fun getMockDevices(): List<BluethoothDevices> {
    return listOf(
        BluethoothDevices(name = "Bluetooth 1", icon = R.drawable.baseline_bluetooth_24, status = "Conectado", true),
        BluethoothDevices(name = "Bluetooth 2", icon = R.drawable.baseline_bluetooth_24, status = "Conectar", false),
        BluethoothDevices(name = "Bluetooth 3", icon = R.drawable.baseline_bluetooth_24, status = "Conectar", false),
    )
}

@Composable
fun DeviceList(devices: List<BluethoothDevices>) {
